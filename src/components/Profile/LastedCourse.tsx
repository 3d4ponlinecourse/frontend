    ...
    <div className=''>
      ...
      <div className='p-5 m-5 bg-slate-500 rounded-3xl'>
        <div className='grid grid-cols-6 grid-rows-1 gap-4'>
          ...
          <div x-data="scrollProgress" className=" bg-yellow-400 flex justify-center items-center col-start-5">
              <svg className="w-20 h-20">
              <circle
              className="text-gray-300"
              stroke-width="5"
          ...
          <div className='flex items-center'>
            <button className='border border-black p-2 bg-blue-400 rounded-3xl text-xs w-36 col-end-6'>Resume Learning</button>
          </div>  
        </div>
      </div>
    </div>
