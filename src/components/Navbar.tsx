...
const Navbar = () => {
  ...
  return (
    <nav className=" flex flex-col px-16 bg-zinc-900 sticky top-0 z-50">
        ...
        <ul className="flex flex-row gap-16 ">
          ...
          <li>
            {isLoggedIn ? (
              ...
              <Link
                to="/login"
                className=" border-2 border-teal-400 text-teal-400 px-6 py-2 rounded-full hover:bg-slate-200 hover:text-black "
              >
                Login
              </Link>
            )}
