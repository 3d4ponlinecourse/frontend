...
const Register = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6 rounded-xl w-full my-14 py-5 px-7">
      <div>
        <h1>REGISTRATION</h1>
      ...
      <div className="text-violet-600">
        <button className="text-violet-600 p-3 rounded-lg hover:bg-indigo-800" type="submit">
          Submit
        </button>
      </div>
    </form>
